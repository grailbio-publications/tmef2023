...
ht <- ComplexHeatmap::Heatmap(
  ...
  row_dend_gp = grid::gpar(fontsize = 18),
...
seer_os_age_key_df <- tmef2023::ccga3_tmef_survival_df |>
  ...
  tidyr::crossing(tmef2023::seer_stratified_os |>
                     dplyr::distinct(lower_age, upper_age)) |>
...
surv_all_cancers_plot_w_seer <- surv_all_cancers_plots[[1]]

surv_all_cancers_plot_w_seer$plot <- surv_all_cancers_plot_w_seer$plot +
  ggplot2::geom_line(data = seer_survival_comp_for_tmef_grps,
                     ggplot2::aes(x = months, y = os, color = tmef_grp,
                                  group = tmef_grp),
                     linetype = "dashed")

surv_all_cancers_plot_w_seer
```
